  ...
  return (
    <>
      <SEO
        ...
        openGraph={{
          image:
            'https://res.cloudinary.com/dtbaug0gp/image/upload/v1755609573/kebbu_MINI_LOGO_mj1pf9.png',
        }}
      />
      <div
        ...
        style={{
          background:
            'var(--backgroundd, linear-gradient(151.79deg, rgba(0, 28, 25, 1) 0%, rgba(9, 9, 9, 1) 50%))',
      ...
      >
        ...
        <main
          className={`min-h-screen ${withoutMaxWidth ? 'w-full px-0' : 'max-w-3xl px-6 mx-auto'}`}
        >
          <Outlet />
        </main>
        <Footer />
