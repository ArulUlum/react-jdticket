  ...
  return (
    <>
      ...
      <div ref={sliderRef} className="keen-slider" key={events.length}>
        {loading &&
          [...Array(4)].map((_, i) => (
            <div key={i} className="keen-slider__slide bg-[#1a1a1a] animate-pulse p-4">
          ...
          events.map((event) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 p-2">
                <img
                  src={
                    event.create_by.image ||
                    `https://ui-avatars.com/api/?name=${encodeURIComponent(event?.create_by.name || 'User')}&background=random`
                  }
                  alt="ImageProfile"
