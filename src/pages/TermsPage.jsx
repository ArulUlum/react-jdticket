...
const sections = [
  ...
  },
  {
    title: 'Hubungi Kami',
    subtitle:
      'Untuk pertanyaan atau permintaan bantuan, hubungi kami melalui Email kebbu.workspace@gmail.com atau Whatsapp 08119432148.',
  },
];
  ...
  return (
    <div className="py-10 px-6 text-white">
      ...
      <p className="mb-8 text-responsive-regular text-white">
        Dengan menggunakan atau mengakses Kebbu.id, Anda menyatakan bahwa telah membaca, memahami,
        dan menyetujui seluruh ketentuan di bawah ini. Jika Anda tidak setuju, mohon hentikan
