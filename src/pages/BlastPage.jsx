...
const dummySent = [
  {
    name: 'JoinDong',
    message: 'Selamat Pagi, alajsndasondoau asondsasodnoasuhd nasousdnasndlasjin oausdhalksndliasindo iaosdin oasinds oasndas bdno uboabsdinaosdjb noasndalskjdnlasjdln aosidhao  aosndlaskndfljasbn ajlksndl alskndlasnkdoadhn oainidlaksdnl . o as da',
  ...
  return (
    <div>
        ...
        {showScheduleModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
            <div className="bg-[#141717] rounded-[20px] p-8 w-[350px] md:w-[420px] shadow-lg relative border border-[#212121]">
              ...
              <h2 className="text-white font-['Satoshi-Bold',_sans-serif] text-2xl mb-2">Schedule Blast</h2>
              <p className="text-[#a2a2a2] font-['Satoshi-Medium',_sans-serif] mb-6">Set a date and time to schedule your message.</p>
              ...
              >
                <span><svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path stroke="#171414" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2"/><circle cx="12" cy="12" r="10" stroke="#171414" strokeWidth="2"/></svg></span>
                Schedule
              </button>
            </div>
          </div>
      ...
      <div className="mb-8">
        ...
        {sent.map((item, idx) => (
          <div key={idx} className="bg-[#141717] rounded-lg p-4 mb-2 flex flex-row items-start gap-4">
            {/* Avatar */}
            <img
            ...
            <div className="flex-1">
              <div className="flex items-center mb-1">
                <span className="text-white font-['Satoshi-Bold',_sans-serif] text-base mr-2">{item.name}</span>
                <span className="text-[#a2a2a2] font-['Satoshi-Medium',_sans-serif] text-sm ml-auto">{format(item.sent_date, 'd MMMM yyyy, HH.mm')} WIB</span>
              </div>
      ...
      <div className="mb-8 mt-8">
        <h3 className="text-white text-lg font-['Satoshi-Bold',_sans-serif] mb-4">System Message</h3>
        <div className="flex flex-col space-y-2">
          <div className="bg-[#141717] rounded-lg p-4 flex items-center gap-4">
            <div 
              className="w-12 h-12 rounded-full flex items-center justify-center"
              style={{
                background: "var(--gr-bc-icon, linear-gradient(135deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 100%))"
              }}
            >
            ...
            <div className="flex-1">
              ...
              <div className="text-[#a2a2a2] font-['Satoshi-Medium'] text-sm">Guests will receive automatic reminders via email, Whatsapp, and push notifications.</div>
            </div>
          ...
          <div className="bg-[#141717] rounded-lg p-4 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-[#a2a2a2] font-['Satoshi-Medium'] text-sm">Set up a feedback email to be sent after the event ends.</div>
            </div>
