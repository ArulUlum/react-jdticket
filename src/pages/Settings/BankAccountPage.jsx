  ...
  return (
    <div className="flex flex-col md:flex-row md:items-start gap-4 w-full">
      <div className="flex-1">
        ...
        <div className="mb-4">
          <label className="block text-white text-responsive-medium-normal mb-1">Account Number</label>
          <input
            name="username"
        ...
        <div className="mb-4">
          <label className="block text-white text-responsive-medium-normal mb-1">Account Name</label>
          <input
            name="username"
      ...
      <div className="bg-[#181818] border border-[#232323] rounded-lg p-4 flex items-start gap-2 max-w-[220px]">
        ...
        <span className="text-white text-responsive-caption">Please ensure that the account number and account holder's name are correct</span>
      </div>
    </div>
  );
};
